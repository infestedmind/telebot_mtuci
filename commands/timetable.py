...
def timetable(message):
    ...
    nech = simple_select(conn, cur, select_what=['class_name'], select_from='scamtable', where="week = 'неч'")
    ch = simple_select(conn, cur, select_what=['class_name'], select_from='scamtable', where="week = 'чет'")
